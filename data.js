...
const GOVERNORS = {
  ...
  races: [
    ...
    { state: "Kansas", incumbent: "D", rating: "SR", note: "" },
...
const SENATE = {
  ...
  races: [
    ...
    { state: "Alaska", abbr: "AK", incumbent: "R", incumbentName: "Dan Sullivan", heldBy: "Republican", rating: "TU", note: "Democrat nominee Mary Petola has previously won the AK-AL seat in a more republican leaning midterm indicating she has a strong change.", candidateStatus: "Incumbent Dan Sullivan is running; former Rep. Mary Peltola has entered the Senate race.", polling: "No consistent public general-election polling available yet.", previousResults: "2020 Senate: Sullivan 53.9%, Gross 41.2%. 2024 President: Trump carried Alaska.", demographicTrends: "Republicans retain a baseline edge, but ranked-choice voting and Peltola's rural/Native support keep the ceiling for Democrats higher than in many red states.", analysis: " Democratic nominee Democrat nominee Mary Petola has previously won the AK-AL seat in a more republican leaning midterm indicating she has a strong chance.", ratingHistory: [{ date: "2026-07-06", rating: "LR", note: "Moved onto expanded watch list" }], lastUpdated: "2026-07-06", sources: ["Ballotpedia 2026 Senate elections", "270toWin Cook Political Report ratings", "270toWin 2026 Senate polling"] },
