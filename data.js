...
const SENATE = {
  ...
  races: [
    ...
    { state: "North Carolina", abbr: "NC", incumbent: "OPEN-R", incumbentName: "Thom Tillis", heldBy: "Republican open seat", rating: "TU", note: "Open battleground", candidateStatus: "Open Republican-held seat after Thom Tillis' retirement; former Gov. Roy Cooper is running for Democrats and Michael Whatley is running for Republicans.", polling: "Early public polling is limited, but both parties treat the race as a top pickup/defense target.", previousResults: "2020 Senate: Tillis 48.7%, Cunningham 46.9%. 2024 President: Trump narrowly carried North Carolina.", demographicTrends: "Research Triangle and Charlotte growth helps Democrats, while rural and exurban Republican margins remain strong.", analysis: "North Carolina is a true Toss-up because the state is close, the seat is open, and Democrats have a high-profile recruit.", ratingHistory: [{ date: "2026-07-06", rating: "TU", note: "Initial toss-up rating" }], lastUpdated: "2026-07-06", sources: ["270toWin Cook Political Report ratings", "Ballotpedia 2026 Senate battlegrounds", "Ballotpedia 2026 Senate elections"] },
    ...
    { state: "Texas", abbr: "TX", incumbent: "R", incumbentName: "John Cornyn", heldBy: "Republican", rating: "LR", note: "GOP-favored but expensive", candidateStatus: "Republican-held seat with a contested GOP environment; Democrats need a strong nominee and national tailwind.", polling: "Public polling is developing; early race assumptions are sensitive to the Republican nominee.", previousResults: "2020 Senate: Cornyn 53.5%, Hegar 43.9%. 2024 President: Trump carried Texas.", demographicTrends: "Metro growth and suburban change help Democrats, while border and rural trends have complicated their coalition.", analysis: "Texas is still Republican-leaning, but the cost, size, and potential GOP primary dynamics make it worth a dedicated page.", ratingHistory: [{ date: "2026-07-06", rating: "LR", note: "Initial Likely R rating" }], lastUpdated: "2026-07-06", sources: ["Cook Political Report race summary", "270toWin Cook Political Report ratings", "270toWin 2026 Senate polling"] },
