...
const SENATE = {
  ...
  safeSeatsR: 0,
  races: [
    { state: "Alabama", rating: "SR" },
    { state: "Alaska", rating: "LR" },
    { state: "Arizona", rating: "TU" },
    { state: "Arkansas", rating: "SR" },
    { state: "California", rating: "SD" },
    { state: "Colorado", rating: "SD" },
    { state: "Connecticut", rating: "SD" },
    { state: "Florida", rating: "SR" },
    { state: "Georgia", rating: "TU" },
    { state: "Hawaii", rating: "SD" },
    { state: "Idaho", rating: "SR" },
    { state: "Illinois", rating: "SD" },
    { state: "Iowa", rating: "LR" },
    { state: "Kansas", rating: "SR" },
    { state: "Maine", rating: "LD" },
    { state: "Maryland", rating: "SD" },
    { state: "Massachusetts", rating: "SD" },
    { state: "Michigan", rating: "TD" },
    { state: "Minnesota", rating: "LD" },
    { state: "Nebraska", rating: "SR" },
    { state: "Nevada", rating: "TU" },
    { state: "New Hampshire", rating: "LD" },
    { state: "New Mexico", rating: "LD" },
    { state: "New York", rating: "LD" },
    { state: "Ohio", rating: "LR" },
    { state: "Oklahoma", rating: "SR" },
    { state: "Oregon", rating: "SD" },
    { state: "Pennsylvania", rating: "SD" },
    { state: "Rhode Island", rating: "SD" },
    { state: "South Carolina", rating: "SR" },
    { state: "South Dakota", rating: "SR" },
    { state: "Tennessee", rating: "SR" },
    { state: "Texas", rating: "SR" },
    { state: "Vermont", rating: "SR" },
    { state: "Wisconsin", rating: "TU" },
    { state: "Wyoming", rating: "SR" }
  ],
};
const HOUSE = {
  majority: 218,
